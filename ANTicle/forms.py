...
class InputDataForm(forms.Form):
    ...
    words = forms.IntegerField(required=True, max_value=5000, widget=forms.HiddenInput())
    thema = forms.CharField(required=False, max_length=1000, widget=forms.Textarea(attrs={'class': 'align-top h-12'}))
